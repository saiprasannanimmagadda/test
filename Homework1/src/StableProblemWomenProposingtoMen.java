...
public class StableProblemWomenProposingtoMen
{ 
static int N=5;
...
System.out.println("The stable matchings when women propose to men are as follows");
System.out.println("Women    Men"); 
for (int i = 0; i < N; i++) 
{
    System.out.print(" "); 
    System.out.println( "W" + womenPartner[i] + "     " + "M" +
                          + i );
}
} 
...
{ 
   ...
   int women_priority[][] = new int[][] {{4,0,1,3,2}, 
          ...
          {0,4,3,2,1},
          {3,1,4,2,0}}; 
    stableMarriageProblem(women_priority,men_priority);
}
}